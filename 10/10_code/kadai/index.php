...
if ($flag == false) {
    ...
    while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        if ($result['view_flg'] == 1) {
            $view .= <<<EOS
<dt class="news-list--date">{$result['indate']}</dt>
<dd class="news-list--note"><a href="#">{$result['news_title']}</a></dd>
EOS;
        }
    }
}
...
<div class="wrapper">
    ...
    <section id="news" class="contents-box">
        ...
        <div class="inner">
            ...
            <p class="news-note__more"><a href="news.php">ニュース一覧を見る</a></p>
        </div>
    </section>
